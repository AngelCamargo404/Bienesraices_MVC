<fieldset>
                ...
                <input type="file" name="propiedad[imagen]" id="imagen" accept="image/jepg, image/png">
            ...
            <fieldset>
                ...
                <input type="number" id="habitaciones" value="<?php echo s($propiedad->habitaciones); ?>" name="propiedad[habitaciones]" placeholder="Ej: 3" min="1" max="9">
