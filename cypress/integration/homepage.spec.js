...
describe('Carga la pagina principal', () => {
    ...
    it('Prueba la sección de las Propiedades', () => {
    ...
    it('Prueba el Bloque de Contacto', () => {
        ...
        // Visitar Contacto tomando la URL de forma distinta
